...
# Name this job
#SBATCH --job-name=pcangsd.flt.test
...
INPUT=$WORKING_FOLDER/genotype_likelihoods_SNPs_flt
...
if [ -d "pcangsd_test3" ]
then echo "Working pcangsd_test3 folder exist"; echo "Let's move on."; date
else echo "Working pcangsd_test3 folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/pcangsd_test3; date
fi

#Output folder
OUTPUT=$WORKING_FOLDER/pcangsd_test3
