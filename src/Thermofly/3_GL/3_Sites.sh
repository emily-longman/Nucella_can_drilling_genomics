...
# Unzip maf file 
#gunzip $working_folder/genotype_likelihoods/Thermofly_GL_reduced_minInd_17_depth_4_minMaf_0.1.mafs.gz
...
infile=$working_folder/genotype_likelihoods/Thermofly_GL_reduced_minInd_17_depth_4_minMaf_0.1.mafs
