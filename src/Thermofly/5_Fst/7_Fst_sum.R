...
fst_unweighted_summary<-data.frame(fst_unweighted_mean, fst_unweighted_median, fst_unweighted_range)
...
fst_weighted_summary<-data.frame(fst_weighted_mean, fst_weighted_median, fst_weighted_range)
