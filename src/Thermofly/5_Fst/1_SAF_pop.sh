...
-ref ${ref} -anc ${ref} \
-out $working_folder/SFS_sites/Thermofly_Tom \
-P $CPU \
...
#Olaa Forest (15 ind, reduced to 11 in updated bam file list)
angsd \
-b $working_folder/info/Olaa_bam_filelist_reduced.list \
-ref ${ref} -anc ${ref} \
