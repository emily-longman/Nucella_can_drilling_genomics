...
if [ -d "pcangsd_test2" ]
then echo "Working pcangsd_test2 folder exist"; echo "Let's move on."; date
else echo "Working pcangsd_test2 folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER/pcangsd_test2; date
fi

#Output folder
OUTPUT=$WORKING_FOLDER/pcangsd_test2
