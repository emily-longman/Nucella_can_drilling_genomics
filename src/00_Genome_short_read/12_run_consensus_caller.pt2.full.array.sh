...
if [ -d "final_assembly_full_array" ]
then echo "Working final_assembly_full_array folder exist"; echo "Let's move on."; date
else echo "Working final_assembly_full_array folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER_SCRATCH/consensus/final_assembly_full_array; date
fi
...
sprun_pt2=/gpfs2/scratch/elongman/Nucella_can_drilling_genomics/src/00_Genome_short_read/12_consensus_scripts_extra/split_and_run_sparc.pt2.full.array.sh
