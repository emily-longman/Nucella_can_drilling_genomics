...
else echo "Working bams_clean folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_clean; date
fi

if [ -d "bams_qualimap" ]
then echo "Working bams_qualimap folder exist"; echo "Let's move on."; date
else echo "Working bams_qualimap folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_qualimap; date
fi
...
--threads 4  \
$WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams/Ncan.bam \
> $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_clean/Ncan.bam
...
I=$WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_clean/Ncan.bam \
O=$WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_clean/Ncan.srt.bam \
SO=coordinate \
...
I=$WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_clean/Ncan.srt.bam \
O=$WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_clean/Ncan.srt.rmdp.bam \
M=$WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_clean/Ncan.dupstat.txt \
VALIDATION_STRINGENCY=SILENT REMOVE_DUPLICATES=true

# Index with samtools
samtools index $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_clean/Ncan.srt.rmdp.bam

# Lets do QC on the bam file
$qualimap bamqc \
-bam $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_clean/Ncan.srt.rmdp.bam \
-outdir $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_qualimap/Qualimap_Ncan \
--java-mem-size=$JAVAMEM

# Clean intermediate files
rm $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_clean/Ncan.bam
rm $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_clean/Ncan.srt.bam

# Housekeeping
mv $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/bams_clean/Ncan.dupstat.txt \
$WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_5/mapping_stats
