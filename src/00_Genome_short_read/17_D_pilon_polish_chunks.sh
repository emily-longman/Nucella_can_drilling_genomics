...
--outdir $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_2
...
$seqtk seq ${scaffold}.polished.fasta > $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_2/scaffolds/${scaffold}.polished.fasta
