...
else echo "Working polished_genome_round_3 folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_3; date
fi
...
else echo "Working sams folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_3/sams; date
fi

if [ -d "mapping_stats" ]
then echo "Working mapping_stats folder exist"; echo "Let's move on."; date
else echo "Working mapping_stats folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_3/mapping_stats; date
fi

if [ -d "bams" ]
then echo "Working bams folder exist"; echo "Let's move on."; date
else echo "Working bams folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_3/bams; date
fi
...
> $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_3/sams/Ncan.sam
...
$WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_3/sams/Ncan.sam \
> $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_3/mapping_stats/Ncan.flagstats_raw.sam.txt
