...
scaffolds_dir=$WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_2/scaffolds
...
cmd="cat ${file};"
eval $cmd
done > $WORKING_FOLDER_SCRATCH/pilon/polished_genome_round_2/polished_assembly.fasta