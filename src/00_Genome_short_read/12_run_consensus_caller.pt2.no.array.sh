...
if [ -d "final_assembly_no_array" ]
then echo "Working final_assembly_no_array folder exist"; echo "Let's move on."; date
else echo "Working final_assembly_no_array folder doesnt exist. Let's fix that."; mkdir $WORKING_FOLDER_SCRATCH/consensus/final_assembly_no_array; date
fi
