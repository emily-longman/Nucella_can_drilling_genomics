...
#SBATCH --output=./slurmOutput/SFS_SNPs.%A_%a.out # Standard output
...
realSFS ${INPUT}/Nucella_SNPs.saf.idx \
-maxIter 1000 \
-tole 1e-6 \
-P 1 \
-fold 1 \
> ${OUTPUT}/Nucella_SNPs.sfs

#--------------------------------------------------------------------------------
# Inform that the pipeline is complete
