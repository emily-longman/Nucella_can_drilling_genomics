...
# Name this job
#SBATCH --job-name=gwas_count_all_SNPs
...
-out $WORKING_FOLDER/GWAS/Nucella_SNPs_maf"$MIN_MAF"_pctind"$PERCENT_IND"_mindepth"$MIN_DEPTH"_maxdepth"$MAX_DEPTH_FACTOR".count.all.SNPs.gwas
