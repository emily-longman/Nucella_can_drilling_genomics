...
# Name this job
#SBATCH --job-name=gwas_binary_SNPs_filt
...
-out $WORKING_FOLDER/GWAS/Nucella_SNPs_maf"$MIN_MAF"_pctind"0.65"_mindepth"$MIN_DEPTH"_maxdepth"$MAX_DEPTH_FACTOR".binary.SNPs.gwas
