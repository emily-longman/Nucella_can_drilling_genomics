...
# Name this job
#SBATCH --job-name=Genotype_likelihoods_lower_p
...
#Name of pipeline
PIPELINE=Genotype_likelihoods_lower_p
...
ls -d "$PWD/"* > $OUTPUT/Nucella_bam_lower_p.list
...
angsd_sing -b ${OUTPUT}/Nucella_bam_lower_p.list \
