...
BAMS_FOLDER=$WORKING_FOLDER/bams_merged_subset_2
...
ls -d "$PWD/"* > $OUTPUT/Nucella_bam_test.list
...
-setMinDepthInd 0.1 -minMaf 0.01 \
-SNP_pval 1e-4 

# Dropped-setMaxDepth and minInd currently
# Switched GL to 2 rather than 1, which I used previously
