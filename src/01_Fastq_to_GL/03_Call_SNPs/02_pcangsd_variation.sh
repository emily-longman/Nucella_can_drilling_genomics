...
cp ${INPUT}/Nucella_bam_add_C.list ${OUTPUT}

# Then, run PCA and admixture scores with pcangsd:
SUFFIX="Nucella_poly_covmatrix_add_C"

echo "Analyse covariance matrix on all individuals"

pcangsd -b ${INPUT}/Nucella_SNPs_all_add_C.beagle.gz \
-o ${OUTPUT}/${SUFFIX} \
-t $CPU 
