...
# Name this job
#SBATCH --job-name=extract_format_maf_pruned_site
...
Rscript $SCRIPT_FOLDER/11_Outliers/01_Reformat/01_extract_format_maf_pruned_site.R "$MIN_MAF" "$PERC_IND" "$MIN_DEPTH" "$MAX_DEPTH_FACTOR"