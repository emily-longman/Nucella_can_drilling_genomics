...
results_path_from_root <- find_root_file("results", "stats", "baypass", criterion = has_file("README.md"))
...
# This script will graph the results of baypass
