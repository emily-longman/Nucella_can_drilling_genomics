...
-minMaf $MIN_MAF -K $i -o $WORKING_FOLDER/ngs_admix_pruned/K_output/Nucella_SNPs_maf"$MIN_MAF"_pctind"$PERCENT_IND"_mindepth"$MIN_DEPTH"_maxdepth"$MAX_DEPTH_FACTOR"_pval1e6_pruned_K{$i}_run{$j}
done
done