...
results_path_from_root <- find_root_file("results", "stats", "ngs_admix_pruned", "K_output", criterion = has_file("README.md"))
...
source("/Users/emilylongman/Documents/GitHub/Nucella_can_drilling_genomics/src/01_Fastq_to_GL/06_Population_structure_final/02_C_plot_admix_function.R")
...
results_path_from_root <- find_root_file("results", "stats", "ngs_admix_pruned", criterion = has_file("README.md"))
setwd(results_path_from_root)
...
q<-read.table("Nucella_SNPs_maf0.05_pctind0.5_mindepth0.3_maxdepth2_pval1e6_pruned_K{2}_run{9}.qopt")
...
ggsave("/Users/emilylongman/Documents/GitHub/Nucella_can_drilling_genomics/results/stats/ngs_admix_pruned/N.canaliculata_Admixture_K=2_Site_barplot.jpeg", width = 8, height = 6, device='jpeg', dpi=300)
...
# Read in a qopt file. It is formatted such that there is one row for each individual and one column for the percentage of admixture for each of the K's
q<-read.table("Nucella_SNPs_maf0.05_pctind0.5_mindepth0.3_maxdepth2_pval1e6_pruned_K{3}_run{1}.qopt")
...
ggsave("/Users/emilylongman/Documents/GitHub/Nucella_can_drilling_genomics/results/stats/ngs_admix_pruned/N.canaliculata_Admixture_K=3_Site_barplot.jpeg", width = 8, height = 6, device='jpeg', dpi=300)
...
inName="Nucella_SNPs_maf0.05_pctind0.5_mindepth0.3_maxdepth2_pval1e6_pruned_K{2}_run{9}.qopt" # name of the input file to plot, output of ngsAdmix or ADMIXTURE run
...
ggsave("/Users/emilylongman/Documents/GitHub/Nucella_can_drilling_genomics/results/stats/ngs_admix_pruned/N.canaliculata_pruned_Admixture_K=2_Drilled.jpeg", width = 8, height = 6, device='jpeg', dpi=300)
...
# Plot
ords=plotAdmixture(data=in.tbl,npops=npops,grouping.method="distance",vshift=0.1, colors = colors)
ggsave("/Users/emilylongman/Documents/GitHub/Nucella_can_drilling_genomics/results/stats/ngs_admix_pruned/N.canaliculata_pruned_Admixture_K=1=2_Site.jpeg", width = 8, height = 6, device='jpeg', dpi=300)
...
# Look at log file to find which has lowest 
inName="Nucella_SNPs_maf0.05_pctind0.5_mindepth0.3_maxdepth2_pval1e6_pruned_K{3}_run{1}.qopt" # name of the input file to plot, output of ngsAdmix or ADMIXTURE run
...
# Plot
ords=plotAdmixture(data=in.tbl,npops=npops,grouping.method="distance",vshift=0.1, colors = colors)
ggsave("/Users/emilylongman/Documents/GitHub/Nucella_can_drilling_genomics/results/stats/ngs_admix_pruned/N.canaliculata_pruned_Admixture_K=3_Drilled.jpeg", width = 8, height = 6, device='jpeg', dpi=300)
...
# Plot
ords=plotAdmixture(data=in.tbl,npops=npops,grouping.method="distance",vshift=0.1, colors = colors)
ggsave("/Users/emilylongman/Documents/GitHub/Nucella_can_drilling_genomics/results/stats/ngs_admix_pruned/N.canaliculata_Admixture_K=3_Site.jpeg", width = 8, height = 6, device='jpeg', dpi=300)
