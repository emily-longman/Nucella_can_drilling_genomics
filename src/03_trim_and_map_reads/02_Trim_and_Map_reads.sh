...
then
	...
	echo "Working mapping_stats folder doesnt exist. Lets fix that"
...
then
	...
	echo "Working read_stats folder doesnt exist. Lets fix that"
...
then
	...
	echo "Working joint_bams folder doesnt exist. Lets fix that"
...
then
	...
	echo "Working joint_bams_qualimap folder doesnt exist. Lets fix that"
